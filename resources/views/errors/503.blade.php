...
<head>
    ...
    <title>Coming Soon - Home Sweet Home</title>
...
<div class="masthead">
    <div class="masthead-content text-white">
        <div class="container-fluid px-4 px-lg-0">
            ...
            <!-- to get an API token!-->
            <form id="contactForm" data-sb-form-api-token="d8a526cc-a394-4424-b5de-c69e72c3f89f">
                <!-- Email address input-->
                ...
                <div class="d-none" id="submitSuccessMessage">
                    <div class="text-center mb-3 mt-2">
                        ...
                        We will notify you when our website is up
                        <br />
                    </div>
                </div>
...
<div class="social-icons">
    <div class="d-flex flex-row flex-lg-column justify-content-center align-items-center h-100 mt-3 mt-lg-0">
        ...
        <a class="btn btn-dark m-3" href="https://www.instagram.com/home_sweet_home_apartments/?hl=en"><i class="fab fa-instagram"></i></a>
    </div>
</div>
<!-- Bootstrap core JS-->
